...
| Table | Grain | Purpose |
|---|---|---|
| entities.csv | service inefficiency segment | Segment, owner, and metadata |
| daily_metrics.csv | service inefficiency segment x day | Performance, value, quality, and risk metrics |
